    ...
    <div class="hero-box mb-4">
        ...
        <div>
            ...
            <p class="hero-subtitle mb-0">
                Input pengeluaran material ke produksi / proyek / maintenance
            </p>
        </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="panel-box h-100">
                ...
                <div class="section-head mb-4">
                    <div>
                        <h5>Form Pengeluaran Material</h5>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text"
                                name="keterangan"
                                class="form-control"
                                placeholder="Contoh: Produksi tiang pancang">
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="mini-card">
                ...
                <p class="mb-0 text-muted mt-2">
                    Setiap transaksi keluar akan mengurangi stok sistem otomatis.
                </p>
            </div>
...
<style>
    .hero-box {
        ...
        gap: 20px;
        flex-wrap: wrap;
        box-shadow: 0 18px 35px rgba(239, 68, 68, .18);
    }
